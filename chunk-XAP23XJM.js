import {
  ...
  h as Ee,
  i as ee,
} from "./chunk-AT2NUKJ3.js";
import { a as Xe, b as et, f as O, i as Mi, l as W } from "./chunk-UUTKIRVD.js";
var bn = O((Dd, vn) => {
  "use strict";
  vn.exports = function () {
    return (
...
var Sn = O((I) => {
  ...
  I.getPenaltyN1 = function (e) {
    ...
    for (let l = 0; l < r; l++) {
      ...
      for (let c = 0; c < r; c++) {
        let h = e.get(l, c);
        h === s ? n++ : (n >= 5 && (o += Te.N1 + (n - 5)), (s = h), (n = 1)),
          (h = e.get(c, l)),
          h === a ? i++ : (i >= 5 && (o += Te.N1 + (i - 5)), (a = h), (i = 1));
      }
  ...
  I.getPenaltyN2 = function (e) {
    ...
    for (let n = 0; n < r - 1; n++)
      for (let i = 0; i < r - 1; i++) {
        let s =
          e.get(n, i) + e.get(n, i + 1) + e.get(n + 1, i) + e.get(n + 1, i + 1);
        (s === 4 || s === 0) && o++;
      }
    return o * Te.N2;
  };
  I.getPenaltyN3 = function (e) {
    ...
    for (let s = 0; s < r; s++) {
      n = i = 0;
      for (let a = 0; a < r; a++)
        (n = ((n << 1) & 2047) | e.get(s, a)),
          a >= 10 && (n === 1488 || n === 93) && o++,
          (i = ((i << 1) & 2047) | e.get(a, s)),
          a >= 10 && (i === 1488 || i === 93) && o++;
    }
    return o * Te.N3;
  };
  ...
  I.applyMask = function (e, r) {
    ...
    for (let n = 0; n < o; n++)
      for (let i = 0; i < o; i++)
        r.isReserved(i, n) || r.xor(i, n, us(e, i, n));
  };
...
var fe = O((B) => {
  ...
  var vs = Fr(),
    qr = zr();
  B.NUMERIC = { id: "Numeric", bit: 1, ccBits: [10, 12, 14] };
  B.ALPHANUMERIC = { id: "Alphanumeric", bit: 2, ccBits: [9, 11, 13] };
  B.BYTE = { id: "Byte", bit: 4, ccBits: [8, 16, 16] };
  B.KANJI = { id: "Kanji", bit: 8, ccBits: [8, 10, 12] };
  B.MIXED = { bit: -1 };
  ...
  B.getBestModeForData = function (e) {
    return qr.testNumeric(e)
      ? B.NUMERIC
      : qr.testAlphanumeric(e)
      ? B.ALPHANUMERIC
      : qr.testKanji(e)
      ? B.KANJI
      : B.BYTE;
...
var Wn = O((Pe) => {
  ...
  function xs(t, e, r) {
    for (let o = 1; o <= 40; o++) if (e <= Pe.getCapacity(o, r, t)) return o;
  }
  function jn(t, e) {
...
var Zn = O((th, Vn) => {
  ...
  We.prototype.write = function (e) {
    ...
    i > 0 &&
      ((o = this.data.substr(r)), (n = parseInt(o, 10)), e.put(n, i * 3 + 1));
  };
  Vn.exports = We;
});
var Yn = O((rh, Kn) => {
...
var di = O((qe) => {
  ...
  function ci(t) {
    let e = $t(Et.NUMERIC, A.NUMERIC, t),
      ...
      n;
    return (
      Qt.isKanjiModeEnabled()
        ? ((o = $t(Et.BYTE, A.BYTE, t)), (n = $t(Et.KANJI, A.KANJI, t)))
        : ((o = $t(Et.BYTE_KANJI, A.BYTE, t)), (n = [])),
      e
        .concat(r, o, n)
        .sort(function (s, a) {
  ...
  function Ps(t) {
    return t.reduce(function (e, r) {
      ...
      return o && o.mode === r.mode
        ? ((e[e.length - 1].data += r.data), e)
        : (e.push(r), e);
    }, []);
  }
  function Ms(t) {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      switch (o.mode) {
        case A.NUMERIC:
          ...
          break;
        case A.ALPHANUMERIC:
          e.push([o, { data: o.data, mode: A.BYTE, length: o.length }]);
          break;
        case A.KANJI:
          e.push([o, { data: o.data, mode: A.BYTE, length: oi(o.data) }]);
          break;
        case A.BYTE:
          e.push([{ data: o.data, mode: A.BYTE, length: oi(o.data) }]);
      }
    }
    return e;
  }
  function Rs(t, e) {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      for (let l = 0; l < s.length; l++) {
        let c = s[l],
          h = "" + i + l;
        a.push(h), (r[h] = { node: c, lastCount: 0 }), (o[h] = {});
        for (let m = 0; m < n.length; m++) {
          let u = n[m];
          r[u] && r[u].node.mode === c.mode
            ? ((o[u][h] =
                Gr(r[u].lastCount + c.length, c.mode) -
                Gr(r[u].lastCount, c.mode)),
              (r[u].lastCount += c.length))
            : (r[u] && (r[u].lastCount = c.length),
              (o[u][h] =
                Gr(c.length, c.mode) + 4 + A.getCharCountIndicator(c.mode, e)));
        }
      }
      n = a;
    }
  ...
  function ni(t, e) {
    let r,
      o = A.getBestModeForData(t);
    if (((r = A.from(e, o)), r !== A.BYTE && r.bit < o.bit))
      throw new Error(
        '"' +
          t +
  ...
  qe.fromArray = function (e) {
    return e.reduce(function (r, o) {
      return (
        typeof o == "string"
          ? r.push(ni(o, null))
          : o.data && r.push(ni(o.data, o.mode)),
        r
      );
    }, []);
  };
...
var ui = O((hi) => {
  ...
  function Zs(t, e, r) {
    ...
    r.forEach(function (l) {
      o.put(l.mode.bit, 4),
        o.put(l.getLength(), Ws.getCharCountIndicator(l.mode, t)),
        l.write(o);
    });
  ...
  function Ks(t, e, r) {
    ...
    for (P = 0; P < u; P++) for (Z = 0; Z < s; Z++) R[j++] = k[Z][P];
    return R;
  }
  function Ys(t, e, r, o) {
    let n;
...
`
    ...
    return (
      ...
      e >= 7 && qs(l, e),
      Vs(l, s),
      isNaN(o) && (o = eo.getBestMask(l, Xr.bind(null, l, r))),
      eo.applyMask(o, l),
      Xr(l, r, o),
      {
        modules: l,
  ...
  hi.create = function (e, r) {
    ...
    return (
      typeof r < "u" &&
        ((o = Jr.from(r.errorCorrectionLevel, Jr.M)),
        (n = Xt.from(r.version)),
        (i = eo.from(r.maskPattern)),
        r.toSJISFunc && er.setToSJISFunction(r.toSJISFunc)),
      Ys(e, n, o, i)
    );
  };
});
var ro = O((Me) => {
  ...
  Me.getScale = function (e, r) {
    return r.width && r.width >= e + r.margin * 2
      ? r.width / (e + r.margin * 2)
      : r.scale;
  };
...
var pi = O((tr) => {
  ...
  tr.render = function (e, r, o) {
    ...
    return (
      oo.qrToImageData(l.data, e, n), Gs(a, i, s), a.putImageData(l, 0, 0), i
    );
  };
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      !l && !i && (i = !0),
        t[a]
          ? (s++,
            (a > 0 && l > 0 && t[a - 1]) ||
              ((o += i ? no("M", l + r, 0.5 + c + r) : no("m", n, 0)),
              (n = 0),
              (i = !1)),
            (l + 1 < e && t[a + 1]) || ((o += no("h", s)), (s = 0)))
          : n++;
    }
    return o;
  }
      ...
      s === 2
        ...
        : s === 3 &&
          (e.getContext && typeof n > "u"
            ? ((n = o), (o = void 0))
            : ((n = o), (o = r), (r = e), (e = void 0)));
    } else {
      if (s < 1) throw new Error("Too few arguments provided");
      return (
        s === 1
          ? ((r = e), (e = o = void 0))
          : s === 2 && !e.getContext && ((o = r), (r = e), (e = void 0)),
...
var Mt = window,
  Rt =
    Mt.ShadowRoot &&
    (Mt.ShadyCSS === void 0 || Mt.ShadyCSS.nativeShadow) &&
        ...
        let s = n.getPropertyOptions(i),
          a =
            typeof s.converter == "function"
              ...
              : mr;
        (this._$El = i),
          (this[i] = a.fromAttribute(r, s.type)),
          (this._$El = null);
      }
    }
    requestUpdate(e, r, o) {
      let n = !0;
      e !== void 0 &&
        (((o = o || this.constructor.getPropertyOptions(e)).hasChanged || Lo)(
          this[e],
          r
        )
...
(te[pr] = !0),
  ...
  No?.({ ReactiveElement: te }),
  ((hr = Lt.reactiveElementVersions) !== null && hr !== void 0
    ? hr
...
var fr,
  Bt = window,
  Be = Bt.trustedTypes,
  Bo = Be ? Be.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  wr = "$lit$",
...
var Bi = (t, e) => {
    ...
    for (let a = 0; a < r; a++) {
      let l = t[a],
        ...
        m = -1,
        u = 0;
      for (; u < l.length && ((s.lastIndex = u), (h = s.exec(l)), h !== null); )
        (u = s.lastIndex),
          s === ot
            ? h[1] === "!--"
              ? (s = Do)
              ...
              ? (s = Uo)
              : h[2] !== void 0
              ? (Vo.test(h[2]) && (n = RegExp("</" + h[2], "g")), (s = $e))
              : h[3] !== void 0 && (s = $e)
            : s === $e
            ? h[0] === ">"
              ? ((s = n ?? ot), (m = -1))
              : h[1] === void 0
              ? (m = -2)
              : ((m = s.lastIndex - h[2].length),
                (c = h[1]),
                (s = h[3] === void 0 ? $e : h[3] === '"' ? Wo : jo))
            : s === Wo || s === jo
            ? (s = $e)
            : s === Do || s === Uo
            ? (s = ot)
      ...
      i +=
        s === ot
          ? l + Ni
          : m >= 0
          ? (o.push(c), l.slice(0, m) + wr + l.slice(m) + ce + x)
          : l + ce + (m === -2 ? (o.push(void 0), a) : x);
    }
  ...
  st = class t {
    constructor({ strings: e, _$litType$: r }, o) {
      ...
      for (; (n = Ae.nextNode()) !== null && l.length < a; ) {
        if (n.nodeType === 1) {
          if (n.hasAttributes()) {
            let m = [];
          ...
          if (n.data === zo) l.push({ type: 2, index: i });
          else {
            let m = -1;
            for (; (m = n.data.indexOf(ce, m + 1)) !== -1; )
              l.push({ type: 7, index: i }), (m += ce.length - 1);
          }
        i++;
      }
    }
...
function De(t, e, r = t, o) {
  ...
  return (
    l?.constructor !== c &&
      ((i = l?._$AO) === null || i === void 0 || i.call(l, !1),
      c === void 0 ? (l = void 0) : ((l = new c(t)), l._$AT(t, r, o)),
      o !== void 0
        ? (((s = (a = r)._$Co) !== null && s !== void 0 ? s : (a._$Co = []))[
            o
          ] = l)
        : (r._$Cl = l)),
    l !== void 0 && (e = De(t, l._$AS(t, e.values), l, o)),
    e
  );
}
var vr = class {
    ...
    u(e) {
      ...
      let {
        ...
        i = (
          (r = e?.creationScope) !== null && r !== void 0 ? r : _e
        ).importNode(o, !0);
      Ae.currentNode = i;
      let s = Ae.nextNode(),
        a = 0,
      ...
      for (; c !== void 0; ) {
        if (a === c.index) {
          let h;
          c.type === 2
            ? (h = new at(s, s.nextSibling, this, e))
            : c.type === 1
            ? (h = new c.ctor(s, c.name, c.strings, this, e))
            : c.type === 6 && (h = new Cr(s, this, e)),
            this._$AV.push(h),
            (c = n[++l]);
        }
  ...
  at = class t {
    constructor(e, r, o, n) {
      ...
      (this.type = 2),
        ...
        (this._$AM = o),
        (this.options = n),
        (this._$Cp = (i = n?.isConnected) === null || i === void 0 || i);
    }
    get _$AU() {
      var e, r;
      return (r =
        (e = this._$AM) === null || e === void 0 ? void 0 : e._$AU) !== null &&
        r !== void 0
        ? r
        : this._$Cp;
    }
    ...
    g(e) {
      var r;
      let { values: o, _$litType$: n } = e,
        i =
          typeof n == "number"
            ? this._$AC(e)
            : (n.el === void 0 &&
                (n.el = st.createElement(Ko(n.h, n.h[0]), this.options)),
              n);
    ...
    T(e) {
      ...
      for (let i of e)
        n === r.length
          ? r.push((o = new t(this.k(nt()), this.k(nt()), this, this.options)))
          : (o = r[n]),
          o._$AI(i),
          n++;
    ...
    _$AI(e, r = this, o, n) {
      ...
      if (i === void 0)
        ...
        for (e = i[0], l = 0; l < i.length - 1; l++)
          (c = De(this, a[o + l], r, l)),
            c === re && (c = this._$AH[l]),
            s || (s = !it(c) || c !== this._$AH[l]),
            c === L ? (e = L) : e !== L && (e += (c ?? "") + i[l + 1]),
            (this._$AH[l] = c);
      }
      s && !n && this.j(e);
    }
  ...
  yr = class extends Ue {
    ...
    j(e) {
      e && e !== L
        ? this.element.setAttribute(this.name, Di)
        : this.element.removeAttribute(this.name);
    }
  },
  xr = class extends Ue {
    ...
    _$AI(e, r = this) {
      var o;
      if ((e = (o = De(this, e, r, 0)) !== null && o !== void 0 ? o : L) === re)
        return;
      let n = this._$AH,
        i =
          (e === L && n !== L) ||
...
Fo?.(st, at),
  ((fr = Bt.litHtmlVersions) !== null && fr !== void 0
    ? fr
    : (Bt.litHtmlVersions = [])
  ).push("2.8.0");
var Yo = (t, e, r) => {
...
var v = class extends te {
  ...
  update(e) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(e),
      (this._$Do = Yo(r, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var e;
...
(v.finalized = !0),
  (v._$litElement$ = !0),
  (Er = globalThis.litElementHydrateSupport) === null ||
    Er === void 0 ||
    Er.call(globalThis, { LitElement: v });
var Go = globalThis.litElementPolyfillSupport;
Go?.({ LitElement: v });
(($r = globalThis.litElementVersions) !== null && $r !== void 0
  ? $r
...
function q(t) {
  return w(et(Xe({}, t), { state: !0 }));
}
var Ar,
  Yc =
    ((Ar = window.HTMLSlotElement) === null || Ar === void 0
      ? void 0
      : Ar.prototype.assignedElements) != null
      ? (t, e) => t.assignedElements(e)
      : (t, e) =>
          t.assignedNodes(e).filter((r) => r.nodeType === Node.ELEMENT_NODE);
var Jo = {
    ATTRIBUTE: 1,
    CHILD: 2,
    PROPERTY: 3,
...
var U = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: "ease" };
...
function Fi(t, e, r, o, n) {
  let i,
    s,
    a = 0;
  do (s = e + (r - e) / 2), (i = rn(s, o, n) - t), i > 0 ? (r = s) : (e = s);
  while (Math.abs(i) > Wi && ++a < Hi);
  return s;
}
function Ie(t, e, r, o) {
  if (t === e && r === o) return V;
    ...
    (this.tick = (u) => {
      ...
      e(j),
        ...
        (this.playState === "finished" || g >= this.totalDuration + s)
          ? ((this.playState = "finished"),
            (x = this.resolve) === null || x === void 0 || x.call(this, j))
          : this.playState !== "idle" &&
...
function jt(t) {
  return (
    Mr.has(t) || Mr.set(t, { transforms: [], values: new Map() }), Mr.get(t)
  );
}
function on(t, e) {
...
var Vi = ["", "X", "Y", "Z"],
  ...
  mt = { x: "translateX", y: "translateY", z: "translateZ" },
  nn = {
    syntax: "<angle>",
    initialValue: "0deg",
...
function ln(t) {
  if (!an.has(t)) {
    an.add(t);
    try {
      let { syntax: e, initialValue: r } = he.has(t) ? he.get(t) : {};
...
var Rr = (t, e) => document.createElement("div").animate(t, e),
  cn = {
    ...
    finished: () => !!Rr({ opacity: [0, 1] }, { duration: 0.001 }).finished,
    linearEasing: () => {
      try {
        Rr({ opacity: 0 }, { easing: "linear(0, 1)" });
      } catch {
        return !1;
      }
      return !0;
...
function mn(t, e, r, o = {}, n) {
  ...
  let P = ft(e),
    ...
    F = he.get(P);
  return (
    zt(Z.animation, !(je(u) && Z.generator) && o.record !== !1),
    () => {
      let ae = () => {
          var N, Qe;
          return (Qe =
            (N = gt.get(t, P)) !== null && N !== void 0
              ? N
              : F?.initialValue) !== null && Qe !== void 0
            ? Qe
            : 0;
        },
        D = dn(hn(r), ae),
      ...
      if (
        (pt(P) && (ue.cssRegisterProperty() ? ln(P) : (j = !1)),
        R && !ue.linearEasing() && (K(u) || (Q(u) && u.some(K))) && (j = !1),
        j)
      ) {
        F && (D = D.map((Ce) => (oe(Ce) ? F.toDefaultUnit(Ce) : Ce))),
          D.length === 1 && (!ue.partialKeyframes() || s) && D.unshift(ae());
        let N = {
          delay: de.ms(c),
          duration: de.ms(l),
          endDelay: de.ms(h),
        ...
        a.finished
          ...
          .catch(dt),
          k || (a.playbackRate = 1.000001);
      } else if (n && R)
        (D = D.map((N) => (typeof N == "string" ? parseFloat(N) : N))),
          D.length === 1 && D.unshift(parseFloat(ae())),
          (a = new n(
            (N) => {
              gt.set(t, P, ko ? ko(N) : N);
            },
            D,
            Object.assign(Object.assign({}, o), { duration: l, easing: u })
          ));
      else {
        let N = D[D.length - 1];
      ...
      return (
        s &&
          i(
            ...
            e,
            D,
            { duration: l, delay: c, easing: u, repeat: m, offset: p },
            "motion-one"
          ),
        Z.setAnimation(a),
        a && !y && a.pause(),
...
var os = (t) => t(),
  wt = (t, e, r = U.duration) =>
    new Proxy(
      { animations: t.map(os).filter(Boolean), duration: r, options: e },
      is
    ),
  ns = (t) => t.animations[0],
  is = {
    get: (t, e) => {
      ...
      switch (e) {
        ...
        case "finished":
          return (
            t.finished ||
              (t.finished = Promise.all(t.animations.map(ss)).catch(dt)),
            t.finished
          );
        case "stop":
          return () => {
...
var ra = Object.defineProperty,
  ...
  xi = (t, e, r) =>
    e in t
      ? ra(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r })
      : (t[e] = r),
  ao = (t, e) => {
    for (var r in e || (e = {})) oa.call(e, r) && xi(t, r, e[r]);
    if (yi) for (var r of yi(e)) na.call(e, r) && xi(t, r, e[r]);
    return t;
  };
function ia() {
  var t;
...
var E = {
  ...
  Ve = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? la(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
  ...
  we = class extends v {
    ...
    render() {
      ...
      return (
        ...
        d`<button class="${J(t)}" ?disabled="${this.disabled}" @click="${
          this.onClick
        }">${
          this.iconLeft
...
(we.styles = [E.globalCss, sa]),
  Ve([w({ type: Boolean })], we.prototype, "disabled", 2),
  Ve([w()], we.prototype, "iconLeft", 2),
  Ve([w()], we.prototype, "iconRight", 2),
  Ve([w()], we.prototype, "onClick", 2),
  Ve([w()], we.prototype, "variant", 2),
  (we = Ve([C("wcm-button")], we));
var ca = $`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`,
  ...
  lo = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? ha(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  _t = class extends v {
    ...
    render() {
      let t = { "wcm-secondary": this.variant === "secondary" };
      return d`<button ?disabled="${this.disabled}" class="${J(
        t
      )}"><slot></slot></button>`;
    }
  };
(_t.styles = [E.globalCss, ca]),
  lo([w({ type: Boolean })], _t.prototype, "disabled", 2),
  lo([w()], _t.prototype, "variant", 2),
  (_t = lo([C("wcm-button-big")], _t));
var ua = $`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`,
  ...
  fa = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? pa(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
var _ = {
  ...
  ba = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? va(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
var ya = $`main{padding:20px;padding-top:0;width:100%}`,
  ...
  Ea = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? Ca(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
var $a = $`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`,
  ...
  Oa = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? _a(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
var Ia = $`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`,
  ...
  Ot = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? ka(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
    ...
    render() {
      let t = { "wcm-border": this.border },
        ...
        r = this.title
          ...
          : d`<slot></slot>`;
      return d`<header class="${J(t)}">${
        e ? this.backBtnTemplate() : null
      } ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
    }
  };
(Re.styles = [E.globalCss, Ia]),
  Ot([w()], Re.prototype, "title", 2),
  Ot([w()], Re.prototype, "onAction", 2),
  Ot([w()], Re.prototype, "actionIcon", 2),
  Ot([w({ type: Boolean })], Re.prototype, "border", 2),
  (Re = Ot([C("wcm-modal-header")], Re));
var f = {
    ...
    handleMobileLinking(t) {
      let { walletConnectUri: e } = G.state,
        { mobile: r, name: o } = t,
        n = r?.native,
        i = r?.universal;
      f.setRecentWallet(t);
      function s(a) {
        let l = "";
        n
          ? (l = b.formatUniversalUrl(n, a, o))
          : i && (l = b.formatNativeUrl(i, a, o)),
          b.openHref(l, "_self");
      }
      e && s(e);
    },
    handleAndroidLinking() {
      let { walletConnectUri: t } = G.state;
    ...
    getCachedRouterWalletPlatforms() {
      let { desktop: t, mobile: e } = b.getWalletRouterData(),
        r = !!t?.native,
        o = !!t?.universal,
        n = !!e?.native || !!e?.universal;
  ...
  po = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? Ma(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
(It.styles = [E.globalCss, Ta]),
  po([q()], It.prototype, "view", 2),
  po([q()], It.prototype, "prevView", 2),
  (It = po([C("wcm-modal-router")], It));
var Ra = $`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`,
  ...
  rr = class extends v {
    ...
    render() {
      let { message: t, variant: e } = ee.state,
        r = { "wcm-success": e === "success", "wcm-error": e === "error" };
      return this.open
        ? d`<div class="${J(r)}">${e === "success" ? _.CHECKMARK_ICON : null} ${
            e === "error" ? _.CROSS_ICON : null
          }<wcm-text variant="small-regular">${t}</wcm-text></div>`
        : null;
    }
  };
(rr.styles = [E.globalCss, Ra]),
  Ei([q()], rr.prototype, "open", 2),
  (rr = Ei([C("wcm-modal-toast")], rr));
var Ba = 0.1,
  $i = 2.5,
  se = 7;
function fo(t, e, r) {
...
function Da(t, e) {
  let r = Array.prototype.slice.call(
      Ti.default.create(t, { errorCorrectionLevel: e }).modules.data,
      0
    ),
...
var Ua = {
    generate(t, e, r) {
      ...
      l.forEach(({ x: g, y: p }) => {
        ...
        for (let R = 0; R < l.length; R += 1) {
          let j = a * (se - R * 2);
          i.push(
            S`<rect fill="${R % 2 === 0 ? o : n}" height="${j}" rx="${
              j * M
            }" ry="${j * M}" width="${j}" x="${k + a * R}" y="${y + a * R}">`
          );
        }
      });
      ...
      s.forEach((g, p) => {
        g.forEach((k, y) => {
          if (
            ...
            !(
              (p < se && y < se) ||
              (p > s.length - (se + 1) && y < se) ||
              (p < se && y > s.length - (se + 1))
            ) &&
            !(p > h && p < m && y > h && y < m)
          ) {
            let M = p * a + a / 2,
      ...
      return (
        ...
        Object.entries(x)
          ...
          .forEach(([g, p]) => {
            p.forEach(([k, y]) => {
              i.push(
                S`<line x1="${g}" x2="${g}" y1="${k}" y2="${y}" stroke="${o}" stroke-width="${
                  a / ($i / 2)
  ...
  ve = class extends v {
    ...
    svgTemplate() {
      ...
      return S`<svg height="${t}" width="${t}">${Ua.generate(
        this.uri,
        t,
        t / 4
      )}</svg>`;
    ...
    render() {
      let t = { "wcm-dark": Ee.state.themeMode === "dark" };
      return d`<div style="${`width: ${this.size}px`}" class="${J(t)}">${
        this.walletId || this.imageUrl
          ? d`<wcm-wallet-image walletId="${H(this.walletId)}" imageId="${H(
              this.imageId
            )}" imageUrl="${H(this.imageUrl)}"></wcm-wallet-image>`
          : _.WALLET_CONNECT_ICON_COLORED
      } ${this.svgTemplate()}</div>`;
    }
  };
(ve.styles = [E.globalCss, ja]),
  Ze([w()], ve.prototype, "uri", 2),
  Ze([w({ type: Number })], ve.prototype, "size", 2),
  Ze([w()], ve.prototype, "imageId", 2),
  Ze([w()], ve.prototype, "walletId", 2),
  Ze([w()], ve.prototype, "imageUrl", 2),
  (ve = Ze([C("wcm-qrcode")], ve));
var Fa = $`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`,
  ...
  Ai = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? qa(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
(or.styles = [E.globalCss, Fa]),
  Ai([w()], or.prototype, "onChange", 2),
  (or = Ai([C("wcm-search-input")], or));
...
(St.styles = [E.globalCss, Ga]),
  wo([w()], St.prototype, "variant", 2),
  wo([w()], St.prototype, "color", 2),
  (St = wo([C("wcm-text")], St));
var Xa = $`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`,
  ...
  be = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? tl(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  X = class extends v {
    ...
    handleClick() {
      To.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
        this.onClick();
    }
    render() {
      var t;
      return d`<button @click="${this.handleClick.bind(
        this
      )}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${H(
        this.imageId
      )}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${
        (t = this.label) != null ? t : f.getWalletName(this.name, !0)
      }</wcm-text>${this.sublabelTemplate()}</div></button>`;
    }
  };
(X.styles = [E.globalCss, Xa]),
  be([w()], X.prototype, "onClick", 2),
  be([w()], X.prototype, "name", 2),
  be([w()], X.prototype, "walletId", 2),
  be([w()], X.prototype, "label", 2),
  be([w()], X.prototype, "imageId", 2),
  be([w({ type: Boolean })], X.prototype, "installed", 2),
  be([w({ type: Boolean })], X.prototype, "recent", 2),
  (X = be([C("wcm-wallet-button")], X));
    ...
    render() {
      ...
      let e =
        (t = this.imageUrl) != null && t.length
          ? this.imageUrl
          : f.getWalletIcon({ id: this.walletId, image_id: this.imageId });
      return d`${
        e.length
          ? d`<div><img crossorigin="anonymous" src="${e}" alt="${this.id}"></div>`
          : _.WALLET_PLACEHOLDER
      }`;
    }
  };
(Ke.styles = [E.globalCss, rl]),
  nr([w()], Ke.prototype, "walletId", 2),
  nr([w()], Ke.prototype, "imageId", 2),
  nr([w()], Ke.prototype, "imageUrl", 2),
  (Ke = nr([C("wcm-wallet-image")], Ke));
    ...
    preloadListings() {
      return W(this, null, function* () {
        if (le.state.enableExplorer) {
          ...
          let { recomendedWallets: t } = z.state,
            e = t.map((r) => f.getWalletIcon(r));
...
_i([q()], vo.prototype, "preload", 2),
  (vo = _i([C("wcm-explorer-context")], vo));
var al = Object.defineProperty,
  ll = Object.getOwnPropertyDescriptor,
  cl = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? ll(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
var dl = $`@keyframes scroll{0%{transform:translate3d(0,0,0)}100%{transform:translate3d(calc(-70px * 9),0,0)}}.wcm-slider{position:relative;overflow-x:hidden;padding:10px 0;margin:0 -20px;width:calc(100% + 40px)}.wcm-track{display:flex;width:calc(70px * 18);animation:scroll 20s linear infinite;opacity:.7}.wcm-track svg{margin:0 5px}wcm-wallet-image{width:60px;height:60px;margin:0 5px;border-radius:var(--wcm-wallet-icon-border-radius)}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-title{display:flex;align-items:center;margin-bottom:10px}.wcm-title svg{margin-right:6px}.wcm-title path{fill:var(--wcm-accent-color)}wcm-modal-footer .wcm-title{padding:0 10px}wcm-button-big{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%);filter:drop-shadow(0 0 17px var(--wcm-color-bg-1))}wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-info-footer wcm-text{text-align:center;margin-bottom:15px}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`,
  ...
  ml = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? ul(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  bo = class extends v {
    ...
    render() {
      let { recomendedWallets: t } = z.state,
        e = [...t, ...t],
        r = b.RECOMMENDED_WALLET_AMOUNT * 2;
...
(bo.styles = [E.globalCss, dl]),
  (bo = ml([C("wcm-android-wallet-selection")], bo));
var pl = $`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`,
  ...
  ye = class extends v {
    ...
    svgLoaderTemplate() {
      ...
      let r =
          (e =
            (t = Ee.state.themeVariables) == null
              ? void 0
              : t["--wcm-wallet-icon-large-border-radius"]) != null
            ? e
            : E.getPreset("--wcm-wallet-icon-large-border-radius"),
        o = 0;
      r.includes("%")
        ? (o = (88 / 100) * parseInt(r, 10))
        : (o = parseInt(r, 10)),
        (o *= 1.17);
      let n = 317 - o * 1.57,
        i = 425 - o * 1.8;
    ...
    render() {
      ...
      return d`<div class="${J(
        t
      )}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${H(
        this.walletId
      )}" imageId="${H(
        this.imageId
...
(ye.styles = [E.globalCss, pl]),
  Ye([w()], ye.prototype, "walletId", 2),
  Ye([w()], ye.prototype, "imageId", 2),
  Ye([w({ type: Boolean })], ye.prototype, "isError", 2),
  Ye([w({ type: Boolean })], ye.prototype, "isStale", 2),
  Ye([w()], ye.prototype, "label", 2),
  (ye = Ye([C("wcm-connector-waiting")], ye));
var Je = {
    manualWallets() {
      var t, e;
      let { mobileWallets: r, desktopWallets: o } = le.state,
        n = (t = Je.recentWallet()) == null ? void 0 : t.id,
        i = b.isMobile() ? r : o,
        s = i?.filter((a) => n !== a.id);
      return (e = b.isMobile()
        ? s?.map(({ id: a, name: l, links: c }) => ({
            id: a,
            name: l,
            mobile: c,
            links: c,
  ...
  xe = {
    ...
    manualWalletsTemplate() {
      return Je.manualWallets().map(
        (t) =>
          d`<wcm-wallet-button walletId="${t.id}" name="${
            t.name
          }" .onClick="${() => this.onConnecting(t)}"></wcm-wallet-button>`
      );
    },
    recomendedWalletsTemplate(t = !1) {
      return Je.recomendedWallets(t).map(
        (e) =>
          d`<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${
            e.image_id
    ...
    recentWalletTemplate() {
      ...
      if (t)
        return d`<wcm-wallet-button name="${t.name}" walletId="${
          t.id
        }" imageId="${H(t.image_id)}" .recent="${!0}" .onClick="${() =>
  ...
  yl = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? bl(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  yo = class extends v {
    render() {
      let { explorerExcludedWalletIds: t, enableExplorer: e } = le.state,
        r = t !== "ALL" && e,
        o = xe.manualWalletsTemplate(),
        n = xe.recomendedWalletsTemplate(),
        i = [xe.recentWalletTemplate(), ...o, ...n];
      i = i.filter(Boolean);
      let s = i.length > 4 || r,
        a = [];
      s ? (a = i.slice(0, 3)) : (a = i);
...
(yo.styles = [E.globalCss, wl]),
  (yo = yl([C("wcm-desktop-wallet-selection")], yo));
var xl = $`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`,
  ...
  $l = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? El(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  xo = class extends v {
    render() {
      let { termsOfServiceUrl: t, privacyPolicyUrl: e } = le.state;
      return t ?? e
        ? d`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
            t
              ? d`<a href="${t}" target="_blank" rel="noopener noreferrer">Terms of Service</a>`
              : null
          } ${t && e ? "and" : null} ${
            e
...
var Al = $`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`,
  ...
  Il = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? Ol(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  Co = class extends v {
    ...
    render() {
      ...
      return d`<wcm-modal-header title="Connect your wallet" .onAction="${
        this.onQrcode
      }" .actionIcon="${_.QRCODE_ICON}"></wcm-modal-header>${
        l
          ? d`<wcm-modal-content><div>${a} ${
              s
                ? d`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`
                : null
...
(Co.styles = [E.globalCss, Al]),
  (Co = Il([C("wcm-mobile-wallet-selection")], Co));
  ...
  kt = class extends v {
    constructor() {
      super(),
        ...
        (this.unsubscribeModal = tt.subscribe((t) => {
    ...
    render() {
      ...
      return d`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${J(
        t
      )}" @click="${
        this.onCloseModal
...
(kt.styles = [E.globalCss, Sl]),
  Eo([q()], kt.prototype, "open", 2),
  Eo([q()], kt.prototype, "active", 2),
  (kt = Eo([C("wcm-modal")], kt));
  ...
  Ne = class extends v {
    ...
    render() {
      return d`<div>${this.isRetry ? d`<slot></slot>` : null} ${
        this.isMobile
          ? d`<wcm-button .onClick="${this.onMobile}" .iconLeft="${_.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
          : null
      } ${
        this.isDesktop
          ? d`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${_.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
          : null
      } ${
        this.isWeb
          ? d`<wcm-button .onClick="${this.onWeb}" .iconLeft="${_.GLOBE_ICON}" variant="outline">Web</wcm-button>`
          : null
      }</div>`;
    }
  };
(Ne.styles = [E.globalCss, Pl]),
  Tt([w({ type: Boolean })], Ne.prototype, "isMobile", 2),
  Tt([w({ type: Boolean })], Ne.prototype, "isDesktop", 2),
  Tt([w({ type: Boolean })], Ne.prototype, "isWeb", 2),
  Tt([w({ type: Boolean })], Ne.prototype, "isRetry", 2),
  (Ne = Tt([C("wcm-platform-selection")], Ne));
var Nl = $`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`,
  ...
  $o = class extends v {
    ...
    render() {
      ...
      return d`<button @click="${this.onClick}"><div class="wcm-icons">${r.map(
        (o) => {
          let n = f.getWalletIcon(o);
          if (n) return d`<img crossorigin="anonymous" src="${n}">`;
          let i = f.getWalletIcon({ id: o.id });
          return i
...
($o.styles = [E.globalCss, Nl]),
  ($o = Dl([C("wcm-view-all-wallets-button")], $o));
      ...
      return d`<div class="wcm-qr-container">${
        this.uri
          ? d`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
              this.uri
            }" walletId="${H(this.walletId)}" imageId="${H(
              this.imageId
            )}"></wcm-qrcode>`
...
(Ge.styles = [E.globalCss, Ul]),
  ir([w()], Ge.prototype, "walletId", 2),
  ir([w()], Ge.prototype, "imageId", 2),
  ir([q()], Ge.prototype, "uri", 2),
  (Ge = ir([C("wcm-walletconnect-qr")], Ge));
...
var ql = $`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`,
  ...
  Ii = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? Zl(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  sr = class extends v {
    ...
    onFormatAndRedirect(t) {
      let { desktop: e, name: r } = b.getWalletRouterData(),
        o = e?.native;
      if (o) {
    ...
    openDesktopApp() {
      let { walletConnectUri: t } = G.state,
        e = b.getWalletRouterData();
      f.setRecentWallet(e), t && this.onFormatAndRedirect(t);
    }
    render() {
      let { name: t, id: e, image_id: r } = b.getWalletRouterData(),
        { isMobile: o, isWeb: n } = f.getCachedRouterWalletPlatforms();
      return d`<wcm-modal-header title="${t}" .onAction="${
        f.handleUriCopy
      }" .actionIcon="${
        _.COPY_ICON
      }"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${H(
        r
      )}" label="${`Continue in ${t}...`}" .isError="${
        this.isError
      }"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${t} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${o}" .isWeb="${n}" .isRetry="${!0}"><wcm-button .onClick="${this.openDesktopApp.bind(
        this
      )}" .iconRight="${
        _.RETRY_ICON
...
(sr.styles = [E.globalCss, ql]),
  Ii([q()], sr.prototype, "isError", 2),
  (sr = Ii([C("wcm-desktop-connecting-view")], sr));
var Kl = $`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`,
  ...
  _o = class extends v {
    ...
    render() {
      ...
      return d`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${H(
        r
...
var Ql = $`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`,
  ...
  Si = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? ec(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  ar = class extends v {
    ...
    onFormatAndRedirect(t, e = !1) {
      let { mobile: r, name: o } = b.getWalletRouterData(),
        n = r?.native,
        i = r?.universal;
      if (n && !e) {
    ...
    render() {
      let {
        ...
        { isWeb: i } = f.getCachedRouterWalletPlatforms(),
        s = o?.ios,
        a = n?.universal;
      return d`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${H(
        r
        ...
        a
          ...
          : null
      }</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${e}" imageId="${H(
        r
...
(ar.styles = [E.globalCss, Ql]),
  Si([q()], ar.prototype, "isError", 2),
  (ar = Si([C("wcm-mobile-connecting-view")], ar));
var tc = $`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`,
  ...
  nc = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? oc(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  Oo = class extends v {
    render() {
      let { name: t, id: e, image_id: r } = b.getWalletRouterData(),
        { isDesktop: o, isWeb: n } = f.getCachedRouterWalletPlatforms();
      return d`<wcm-modal-header title="${t}" .onAction="${
        f.handleUriCopy
      }" .actionIcon="${
        _.COPY_ICON
      }"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${e}" imageId="${H(
        r
      )}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${t} app`}</wcm-text><wcm-platform-selection .isDesktop="${o}" .isWeb="${n}"></wcm-platform-selection></wcm-info-footer>`;
    }
  };
(Oo.styles = [E.globalCss, tc]),
  (Oo = nc([C("wcm-mobile-qr-connecting-view")], Oo));
var ic = Object.defineProperty,
  sc = Object.getOwnPropertyDescriptor,
  ac = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? sc(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
...
var lc = $`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`,
  ...
  Pt = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? dc(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  Le = class extends v {
    constructor() {
      super(...arguments),
        ...
        (this.searchDebounce = f.debounce((t) => {
          t.length >= 1
            ? ((this.firstFetch = !0),
              (this.endReached = !1),
              (this.search = t),
    ...
    isLastPage() {
      let { wallets: t, search: e } = z.state,
    ...
    fetchWallets() {
      return W(this, null, function* () {
        var t;
        let { wallets: e, search: r } = z.state,
          { listings: o, total: n, page: i } = this.search ? r : e;
        if (!this.endReached && (this.firstFetch || (n > So && o.length < n)))
          try {
            this.loading = !0;
            let s = (t = G.state.chains) == null ? void 0 : t.join(","),
              { listings: a } = yield z.getWallets({
    ...
    render() {
      let { wallets: t, search: e } = z.state,
        ...
        i = xe.manualWalletsTemplate(),
        s = xe.recomendedWalletsTemplate(!0);
      n &&
        ((i = i.filter(({ values: c }) =>
      ...
      return d`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
        this
      )}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${J(
        l
      )}"><div class="wcm-grid">${o ? null : i} ${o ? null : s} ${
        o
          ? null
          : r.map(
              (c) =>
        ...
        !a && this.loading ? d`<wcm-spinner></wcm-spinner>` : null
      }</div></wcm-modal-content>`;
    }
  };
(Le.styles = [E.globalCss, lc]),
  Pt([q()], Le.prototype, "loading", 2),
  Pt([q()], Le.prototype, "firstFetch", 2),
  Pt([q()], Le.prototype, "search", 2),
  Pt([q()], Le.prototype, "endReached", 2),
  (Le = Pt([C("wcm-wallet-explorer-view")], Le));
var hc = $`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`,
  ...
  ki = (t, e, r, o) => {
    for (
      var n = o > 1 ? void 0 : o ? mc(e, r) : e, i = t.length - 1, s;
      i >= 0;
      i--
    )
      (s = t[i]) && (n = (o ? s(e, r, n) : s(n)) || n);
  ...
  lr = class extends v {
    ...
    render() {
      let { name: t, id: e, image_id: r } = b.getWalletRouterData(),
        { isMobile: o, isDesktop: n } = f.getCachedRouterWalletPlatforms(),
        i = b.isMobile();
      return d`<wcm-modal-header title="${t}" .onAction="${
        f.handleUriCopy
      }" .actionIcon="${
...
(lr.styles = [E.globalCss, hc]),
  ki([q()], lr.prototype, "isError", 2),
  (lr = ki([C("wcm-web-connecting-view")], lr));
export { kt as WcmModal, ve as WcmQrCode };
